...
**Бэкенд:** Серверная логика с использованием фреймворка Django. 

Настроено подключение шаблонов, статических файлов в settings.py.

Созданы модели данных и настроены маршруты для обработки запросов с помощью MVT.
